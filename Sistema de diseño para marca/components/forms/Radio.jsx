...
export function Radio({ label, checked, onChange, name, value, disabled, style }) {
  return (
    <label style={{ display: "inline-flex", alignItems: "center", gap: 10, cursor: disabled ? "not-allowed" : "pointer", font: "var(--type-body)", color: "var(--text-body)", opacity: disabled ? 0.5 : 1, ...style }}>
